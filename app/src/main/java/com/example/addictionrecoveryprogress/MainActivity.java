...
public class MainActivity extends AppCompatActivity {
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if (checkedId == R.id.radio_isVictory) {
                    ...
                    Log.i(TAG, "Setback selected; add mood, time, and location to view");
        ...
        addUpdateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    // TODO - remove and perform correct error handling for future dates
                    Calendar currDate = Calendar.getInstance();
                    currDate.getTime();
                    if (reportDate.after(currDate)) {
                        Log.e(TAG, "Invalid date; future date selected");
                    }
    ...
    public void createDatePicker() {
        ...
        Log.i(TAG, "Calendar icon selected; date picker launched");
